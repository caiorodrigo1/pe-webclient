...
export class TipoDocumentoComponent implements OnInit, OnDestroy {
  ...
  private carregarTabela$(): void {
    ...
    this.inscricaoTabela = this.tipoDocumentoService
  ...
  protected confirmarExclusao(tipoDocumento: ITipoDocumento): void {
    this.confirmationService.confirm({
      message: `Tem certeza que deseja excluir ${tipoDocumento.nome}?`,
      header: `Excluir ${this.recipiente}`,
      icon: 'pi pi-exclamation-triangle',
      accept: () => this.excluir(tipoDocumento.id!),
    });
  }
  ...
  private excluir(id: number): void {
    ...
    this.inscricaoExcluir = this.tipoDocumentoService
      .excluirTipoDocumento(id)
      .subscribe({
        complete: () => {
