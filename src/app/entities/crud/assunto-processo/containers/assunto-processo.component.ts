...
@Component({
  selector: 'top-assunto-processo',
  templateUrl: './assunto-processo.component.html',
})
export class AssuntoProcessoComponent implements OnInit, OnDestroy {
  entidade: string = 'Assuntos do Processo';
  ...
  protected carregarTabela$(): void {
    ...
    this.inscricaoTabela = this.assuntoProcessoService
  ...
  protected confirmarExclusao(assuntoProcesso: IAssuntoProcesso): void {
    this.confirmationService.confirm({
      message: `Tem certeza que deseja excluir ${assuntoProcesso.nome}?`,
      header: `Excluir ${this.recipiente}`,
      icon: 'pi pi-exclamation-triangle',
      accept: () => this.excluir(assuntoProcesso.id!),
    });
  }
  ...
  private excluir(id: number): void {
    ...
    this.inscricaoExcluir = this.assuntoProcessoService
      .excluirAssuntoProcesso(id)
      .subscribe({
        complete: () => {
