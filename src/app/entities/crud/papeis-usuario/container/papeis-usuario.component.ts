...
@Component({
  selector: 'top-papeis-usuario',
  templateUrl: './papeis-usuario.component.html',
})
export class PapeisUsuarioComponent implements OnInit, OnDestroy {
  entidade: string = 'Papeis dos Usuários';
  recipiente: string = 'Papeis do Usuário';
  ...
  protected carregarTabela$(): void {
    ...
    this.inscricaoTabela = this.papeisUsuarioService
  ...
  protected confirmarExclusao(papeisUsuario: PapeisUsuario): void {
    this.confirmationService.confirm({
      message: `Tem certeza que deseja excluir ${papeisUsuario.nome}?`,
      header: `Excluir ${this.recipiente}`,
      icon: 'pi pi-exclamation-triangle',
      accept: () => this.excluir(papeisUsuario.id!),
    });
  }
  ...
  private excluir(id: number): void {
    ...
    this.inscricaoExcluir = this.papeisUsuarioService
      .excluirPapeisUsuario(id)
      .subscribe({
        complete: () => {
