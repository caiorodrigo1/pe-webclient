export const slideDown = function (elm: any, duration: number = 300) {
...
export const slideUp = function (elm: any, duration: number = 300) {
  if (!elm.classList.contains('transitioning')) {
    elm.classList.add('transitioning');
    elm.style.transitionProperty = 'height, margin, padding';
    elm.style.transitionDuration = duration + 'ms';
...
export const slideToggle = function (elm: any, duration: number = 300) {
